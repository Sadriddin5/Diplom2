        ...
        <section className='secBiograph'>
            ...
            <div className="bioOleg">
                <div className="bioTop">
                    ...
                    <div>
                        <h3>
                    <span>Мелехов Олег </span> — заслуженный художник Российской Федерации, объединивший в своём творчестве прусскую, немецкую и русскую культуры. Художник написал более 3000 картин и неоднократно участвовал в выставках не только в России, но и за её пределами.
                ...
                <img className='mol' src={mol} alt="" />
            </div>
            <div className="detstva">
                <h3>
                    Детство и истоки творчества
                </h3>
            </div>
            ...
            <div className="contentBio">
                <p>Вскоре отца перевели на Украину, под Запорожье. В школе уроки рисования вёл военрук.
                     ...
                     мальчика, предрёк ему будущее интересного колориста, предложив не учить, а показывать <br /> своё мастерство.
                     </p>
            </div>
            <div className="detstva">
                <h3>
            ...
            <div className="contentBio">
                <p>Олег участвовал в пленэрах в Прибалтике и на Северном Кавказе, где мастера передавали 
                    ...
                    В древности таких художников называли «сейенах» — воскреситель, способный наполнять <br />  пространство
                    энергией гармонии.
                </p>
            </div>
            <div className="detstva">
            ...
            <div className="contentBio">
                <p>В 1983 году Мелехов стал членом ленинградского Товарищества экспериментального <br /> изобразительного искусства (ТЭИИ).
                     На выставке «Лик» во Дворце культуры имени Кирова <br /> он познакомился с коллекционером Максимовым, 
                     который спасал картины от уничтожения. <br />
                     В 1984 году на отчётной выставке ТЭИИ во Дворце Молодёжи Мелехов представил картины <br />«Щелкунчик и Мари» и «Бог Отец 
                     отправляет своего Сына на Землю». Выставка вызвала восторг<br /> зрителей, но через неделю была закрыта КГБ.
                </p>
            </div>
            <div className="detstva">
                <h3>
                ...
                <div className="yearAndDesc">
                    ...
                    <div className="descBio">
                        ...
                        <div className="desc1Bio">
                            <img src={hor} alt="" />
                            <p>
                                Вступил в ленинградское Товарищество экспериментального <br /> изобразительного 
                        ...
                        <div className="desc1Bio">
                            <img src={hor} alt="" />
                            <p>
                                Участие в резонансной выставке в Ленинградском Дворце молодежи, <br />закрытой КГБ.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="descBio descBio2">
                        ...
                        <div className="desc1Bio  desc2Bio">
                            ...
                            <p>
                               ...
                               во сне <br /> он получил указание от Девы Марии, результатом которого 
                               стал цикл<br /> из 22 картин «Из жизни Иисуса Христа». В том же году 
                               его работы (16 <br /> картин) 
                                были представлены на выставке в Ленинградском Манеже, <br /> посвященной  
