                ...
                <div className="contBotLeft">
                    <div className="contBlocks">
                        ...
                        <div className="contBlockBot">
                            <h5>Коллекционеры</h5>
                            <h6>По вопросам приобретения работ художника обращайтесь по почте</h6>
                        </div>
                    </div>
                    ...
                    <div className="contBlocks">
                        <div className="contBlockTop">
                            ...
                            <h6>Для получения пресс материалов и интервью пишите на почту</h6>
                        </div>
                        <hr />
                        <div className="contBlockBot">
                            <h5>Образовательные учреждения</h5>
                            <h6>Организация мастер-классов и лекций</h6>
                        </div>
                    </div>
                </div>
